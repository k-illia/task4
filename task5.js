...
// cons url = https://api.openweathermap.org/data/2.5/onecall?lat=33.44&lon=-94.04&exclude=hourly,daily&appid=4cedf0ecdc32c14d1375f2487331d55b


function loadSelector() {
    let selector = document.getElementById('selector');
    for (let region in city['regions']) {
        for (let name in city['regions'][region]['name']) {
            let option = document.createElement('option')
            option.innerHTML = city['regions'][region]['cities'][name]['name'];
            option.value = [city['regions'][region]['cities'][name]['lat'], city['regions'][region]['cities'][name]['lng']]
...
function onChange() {
    let selector = document.getElementById('selector');
    let coordinates = selector.value.split(',')
    getDataFromAPI(coordinates);
}
